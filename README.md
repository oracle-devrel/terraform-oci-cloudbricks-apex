...
## Introduction
The following cloud brick enables you to create a fully managed APEX with IaaS Enabled ORDS Fixed Servers
...
| <a name="input_instance_flex_shape_memory"></a> [instance\_flex\_shape\_memory](#input\_instance\_flex\_shape\_memory) | n/a | `number` | `10` | no |
| <a name="input_instance_flex_shape_ocpus"></a> [instance\_flex\_shape\_ocpus](#input\_instance\_flex\_shape\_ocpus) | n/a | `number` | `1` | no |
